...
\begin{table}[H]
    \begin{tabular}{l|l}
        ...
        $c_{St} = 0.31$                  & Reibungskoeffient Backbord/Steuerbord [E]                                          \\ \hline
...
Die erste Bewegungsgleichung für die Bewegung in longitudinaler Richtung, setzt sich zusammen aus den vier folgenden vier Kräften,
\begin{align}
    F_{Lon} = F_{T} - F_{Rl} + F_{Cl} + F_{W}. \label{eq:longitudinal_force}
\end{align}
...
% o\cite[]{graesser2020foundations}
\printbibliography
\end{document}